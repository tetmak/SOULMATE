...
const SUPABASE_URL = 'https://cxkyyifqxbwidseofbgk.supabase.co';
// Service role key veya anon key — hangisi mevcutsa
const SUPABASE_SERVICE_KEY = process.env.SUPABASE_SERVICE_ROLE_KEY ||
    process.env.SUPABASE_SERVICE_KEY ||
    'sb_publishable_zjI0OggICM4s7wz0xpq2WA_Q_6JAHbN';
...
export default async function handler(req, res) {
    ...
    // Anon key kullanılıyorsa RLS kısıtlamaları olacak
    const usingAnon = !process.env.SUPABASE_SERVICE_ROLE_KEY && !process.env.SUPABASE_SERVICE_KEY;
