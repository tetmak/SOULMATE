...
(function() {
    ...
    T.tr = {
        ...
        'signup.intro_title': 'Sayıların Gücüyle<br/><span class="text-primary">Ruhsal Yolculuğuna Başla</span>',
        'signup.intro_desc': 'Numeroloji, uyumluluk analizi ve kozmik rehberlikle hayatındaki gizli anlamı keşfet.',
        'signup.divider_or': 'veya',
        'signup.btn_apple_connect': 'Apple ile bağlan',
        'signup.other_options': 'Diğer seçenekler',
        'signup.btn_google_connect': 'Google ile bağlan',
        'signup.btn_send_code': 'Kod Gönder',
        'signup.legal_text': 'Devam ederek Kullanım Koşullarını ve Gizlilik Politikasını kabul etmiş olursunuz.',
        'signup.trouble_link': 'Bağlantı sorunu mu?',
        'signup.otp_title': 'Kodunu gir',
        'signup.otp_subtitle': ' numarasına kod gönderdik',
        'signup.btn_verify': 'Doğrula',
        'signup.otp_resend_wait': '60 saniye bekleyin',
        'signup.otp_resend': 'Tekrar gönder',
        ...
        'premium.trial_info': 'İlk 7 gün ücretsiz \u00b7 İstediğin zaman iptal',
        ...
        'premium.trial_started': '7 günlük ücretsiz deneme başladı',
    ...
    T.en = {
        ...
        'signup.intro_title': 'With the Power of Numbers<br/><span class="text-primary">Begin Your Spiritual Journey</span>',
        'signup.intro_desc': 'Discover the hidden meaning in your life through numerology, compatibility analysis and cosmic guidance.',
        'signup.divider_or': 'or',
        'signup.btn_apple_connect': 'Connect with Apple',
        'signup.other_options': 'Other options',
        'signup.btn_google_connect': 'Connect with Google',
        'signup.btn_send_code': 'Send Code',
        'signup.legal_text': 'By continuing, you agree to our Terms of Service and Privacy Policy.',
        'signup.trouble_link': 'Having trouble?',
        'signup.otp_title': 'Enter your code',
        'signup.otp_subtitle': ' We sent a code to',
        'signup.btn_verify': 'Verify',
        'signup.otp_resend_wait': 'Wait 60 seconds',
        'signup.otp_resend': 'Resend',
    ...
    T.de = {
        ...
        'signup.intro_title': 'Mit der Kraft der Zahlen<br/><span class="text-primary">Beginne deine spirituelle Reise</span>',
        'signup.intro_desc': 'Entdecke die verborgene Bedeutung in deinem Leben durch Numerologie, Kompatibilitätsanalyse und kosmische Führung.',
        'signup.divider_or': 'oder',
        'signup.btn_apple_connect': 'Mit Apple verbinden',
        'signup.other_options': 'Weitere Optionen',
        'signup.btn_google_connect': 'Mit Google verbinden',
        'signup.btn_send_code': 'Code senden',
        'signup.legal_text': 'Mit dem Fortfahren akzeptierst du unsere Nutzungsbedingungen und Datenschutzrichtlinie.',
        'signup.trouble_link': 'Probleme?',
        'signup.otp_title': 'Code eingeben',
        'signup.otp_subtitle': ' Wir haben einen Code gesendet an',
        'signup.btn_verify': 'Bestätigen',
        'signup.otp_resend_wait': '60 Sekunden warten',
        'signup.otp_resend': 'Erneut senden',
    ...
    T.fr = {
        ...
        'signup.intro_title': 'Avec la Puissance des Nombres<br/><span class="text-primary">Commence ton Voyage Spirituel</span>',
        'signup.intro_desc': 'Découvre le sens caché de ta vie grâce à la numérologie, l\'analyse de compatibilité et la guidance cosmique.',
        'signup.divider_or': 'ou',
        'signup.btn_apple_connect': 'Se connecter avec Apple',
        'signup.other_options': 'Autres options',
        'signup.btn_google_connect': 'Se connecter avec Google',
        'signup.btn_send_code': 'Envoyer le code',
        'signup.legal_text': 'En continuant, vous acceptez nos Conditions d\'utilisation et notre Politique de confidentialité.',
        'signup.trouble_link': 'Un problème ?',
        'signup.otp_title': 'Entre ton code',
        'signup.otp_subtitle': ' Nous avons envoyé un code au',
        'signup.btn_verify': 'Vérifier',
        'signup.otp_resend_wait': 'Attendre 60 secondes',
        'signup.otp_resend': 'Renvoyer',
        ...
        'premium.header_title': 'Paiement', 'premium.plan_name': 'Numantic Premium', 'premium.trial_info': '7 premiers jours gratuits \u00b7 Annule quand tu veux', 'premium.secure_payment': 'Paiement Sécurisé', 'premium.payment_desc': 'En cliquant ci-dessous, le paiement sécurisé sera traité via le store', 'premium.security_note': 'Paiement sécurisé \u00b7 TVA incluse', 'premium.complete_payment': 'Finaliser le Paiement', 'premium.terms_text': 'En finalisant le paiement, tu acceptes les Conditions d\'Utilisation.', 'premium.skip_free': 'Continuer gratuitement pour l\'instant \u2192', 'premium.success_title': 'Premium Actif !', 'premium.success_desc': 'Félicitations ! Tu as maintenant un accès illimité à toutes les fonctionnalités.', 'premium.trial_started': 'Essai gratuit de 7 jours commencé', 'premium.explore_btn': 'Commencer l\'Exploration',
        'store.header_title': 'Numantic Premium', 'store.premium_active': 'Premium Actif', 'store.feature_ai': 'Analyse IA Illimitée', 'store.feature_friends': 'Amis & Compatibilité Illimités', 'store.feature_cosmic': 'Révélation Cosmic Match', 'store.feature_deep': 'Deep Insight Complet (3 pages)', 'store.feature_guide': 'Guide IA Quotidien & Calendrier Cosmique', 'store.hero_title': 'Libère toute la puissance de la Numérologie', 'store.hero_desc': 'Analyse IA illimitée, révélation Cosmic Match, rapports de compatibilité complets et bien plus.', 'store.monthly': 'Mensuel', 'store.save_badge': '37% D\'ÉCONOMIE', 'store.yearly': 'Annuel', 'store.go_premium': 'Passer Premium', 'store.cancel_info': 'Annule quand tu veux \u00b7 7 jours d\'essai gratuit', 'store.comparison_title': 'Gratuit vs Premium', 'store.feature_col': 'Fonctionnalité', 'store.perks_title': 'Avantages Premium', 'store.try_free': '7 Jours d\'Essai Gratuit',
    ...
    T.es = {
        ...
        'signup.intro_title': 'Con el Poder de los Números<br/><span class="text-primary">Comienza tu Viaje Espiritual</span>',
        'signup.intro_desc': 'Descubre el significado oculto en tu vida a través de la numerología, análisis de compatibilidad y guía cósmica.',
        'signup.divider_or': 'o',
        'signup.btn_apple_connect': 'Conectar con Apple',
        'signup.other_options': 'Otras opciones',
        'signup.btn_google_connect': 'Conectar con Google',
        'signup.btn_send_code': 'Enviar código',
        'signup.legal_text': 'Al continuar, aceptas nuestros Términos de Servicio y Política de Privacidad.',
        'signup.trouble_link': '¿Problemas?',
        'signup.otp_title': 'Ingresa tu código',
        'signup.otp_subtitle': ' Enviamos un código al',
        'signup.btn_verify': 'Verificar',
        'signup.otp_resend_wait': 'Espera 60 segundos',
        'signup.otp_resend': 'Reenviar',
    ...
    T.ar = {
        ...
        'signup.intro_title': 'بقوة الأرقام<br/><span class="text-primary">ابدأ رحلتك الروحية</span>',
        'signup.intro_desc': 'اكتشف المعنى الخفي في حياتك من خلال علم الأعداد وتحليل التوافق والإرشاد الكوني.',
        'signup.divider_or': 'أو',
        'signup.btn_apple_connect': 'الاتصال بـ Apple',
        'signup.other_options': 'خيارات أخرى',
        'signup.btn_google_connect': 'الاتصال بـ Google',
        'signup.btn_send_code': 'إرسال الرمز',
        'signup.legal_text': 'بالمتابعة، أنت توافق على شروط الخدمة وسياسة الخصوصية.',
        'signup.trouble_link': 'مشكلة في الاتصال؟',
        'signup.otp_title': 'أدخل الرمز',
        'signup.otp_subtitle': ' أرسلنا رمزاً إلى',
        'signup.btn_verify': 'تحقق',
        'signup.otp_resend_wait': 'انتظر 60 ثانية',
        'signup.otp_resend': 'إعادة الإرسال',
    ...
    T.ru = {
        ...
        'signup.intro_title': 'С Силой Чисел<br/><span class="text-primary">Начни Свой Духовный Путь</span>',
        'signup.intro_desc': 'Раскрой скрытый смысл своей жизни через нумерологию, анализ совместимости и космическое руководство.',
        'signup.divider_or': 'или',
        'signup.btn_apple_connect': 'Подключить Apple',
        'signup.other_options': 'Другие варианты',
        'signup.btn_google_connect': 'Подключить Google',
        'signup.btn_send_code': 'Отправить код',
        'signup.legal_text': 'Продолжая, вы соглашаетесь с Условиями использования и Политикой конфиденциальности.',
        'signup.trouble_link': 'Проблемы?',
        'signup.otp_title': 'Введите код',
        'signup.otp_subtitle': ' Мы отправили код на',
        'signup.btn_verify': 'Подтвердить',
        'signup.otp_resend_wait': 'Подождите 60 секунд',
        'signup.otp_resend': 'Отправить снова',
    ...
    T.pt = {
        ...
        'signup.intro_title': 'Com o Poder dos Números<br/><span class="text-primary">Comece sua Jornada Espiritual</span>',
        'signup.intro_desc': 'Descubra o significado oculto na sua vida através da numerologia, análise de compatibilidade e orientação cósmica.',
        'signup.divider_or': 'ou',
        'signup.btn_apple_connect': 'Conectar com Apple',
        'signup.other_options': 'Outras opções',
        'signup.btn_google_connect': 'Conectar com Google',
        'signup.btn_send_code': 'Enviar código',
        'signup.legal_text': 'Ao continuar, você concorda com nossos Termos de Serviço e Política de Privacidade.',
        'signup.trouble_link': 'Problemas?',
        'signup.otp_title': 'Digite seu código',
        'signup.otp_subtitle': ' Enviamos um código para',
        'signup.btn_verify': 'Verificar',
        'signup.otp_resend_wait': 'Aguarde 60 segundos',
        'signup.otp_resend': 'Reenviar',
