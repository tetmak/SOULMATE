...
(function() {
    ...
    var bubbleItems = [
        ...
        { icon: 'calculate',     label: _t('bubble.new_analysis', 'Yeni Analiz'),     href: 'data-ready_birth_form.html?newperson=1',    color: '#FF2D55', bg: 'rgba(255,45,85,0.2)',  border: 'rgba(255,45,85,0.5)' },
    ...
    style.textContent = [
        ...
        '#numerael-bottom-nav .nav-tab.active{color:#FF2D55}',
        ...
        '#numerael-plus-btn{width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,#FF2D55,#cc1a3e);border:none;display:flex;align-items:center;justify-content:center;cursor:pointer;position:relative;top:-22px;box-shadow:0 4px 20px rgba(255,45,85,0.35);transition:transform 0.2s,box-shadow 0.2s;z-index:1002}',
