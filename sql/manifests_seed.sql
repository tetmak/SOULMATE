-- =====================================================
-- SEED DATA — 35 Turkce manifest (gercek kullanici UUID'leri ile)
...
-- =====================================================
-- SEED LIKES — Fake begeniler (manifest'lere like ekle)
-- Her manifest'e rastgele kullanicilardan like ekliyoruz
-- =====================================================

-- Once manifest ID'lerini alalim ve like ekleyelim
-- Bu blok, manifest'lere farkli kullanicilardan like atar
